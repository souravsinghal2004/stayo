...
import { LayoutDashboard, Car, Calendar, Cog, LogOut , House , DollarSign , SlidersHorizontal}  from "lucide-react";
...
const routes = [
  ...
  {
    label: "Upload New Property",
    icon: House,
    href: "/host/uploadproperty",
  },
  ...
  return (
    <>
      ...
      <div className="hidden md:flex h-full flex-col overflow-y-auto bg-white shadow-sm border-r">
        <div className="p-6">
          <Link href="/host">
            <h1 className="text-xl font-bold">Stayo Host</h1>
          </Link>
        </div>
